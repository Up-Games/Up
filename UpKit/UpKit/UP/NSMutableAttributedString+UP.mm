...
{
    [self setTextAlignment:textAlignment paragraphSpacing:0 range:NSMakeRange(0, self.length)];
}

- (void)setTextAlignment:(NSTextAlignment)textAlignment range:(NSRange)range
{
    [self setTextAlignment:textAlignment paragraphSpacing:0 range:range];
}
