...
#ifndef UP_ANY_ALWAYS_INLINE
#ifdef NDEBUG
#define UP_ANY_ALWAYS_INLINE inline __attribute__ ((__visibility__("hidden"), __always_inline__))
#else
#define UP_ANY_ALWAYS_INLINE inline
#endif
#endif

#ifdef __cpp_rtti
#define UP_ANY_USE_TYPEINFO 1
#else
#define UP_ANY_USE_TYPEINFO 0
#endif

#ifdef __cpp_exceptions
#define UP_ANY_USE_EXCEPTIONS 1
#else
#define UP_ANY_USE_EXCEPTIONS 0
#endif

#ifndef UP_ANY_USE_SMALL_MEMCPY_STRATEGY
#define UP_ANY_USE_SMALL_MEMCPY_STRATEGY 0
#endif

#define UP_ANY_USE(FEATURE) (defined UP_ANY_USE_##FEATURE && UP_ANY_USE_##FEATURE)

namespace UP {

#if UP_ANY_USE(EXCEPTIONS)
class bad_any_cast : public std::bad_cast {};
#endif  // UP_ANY_USE(EXCEPTIONS)

static UP_ANY_ALWAYS_INLINE void handle_bad_any_cast() {
#if UP_ANY_USE(EXCEPTIONS)
    throw bad_any_cast();
#endif
    abort();
...
struct AnyTraits
{
#if UP_ANY_USE(SMALL_MEMCPY_STRATEGY)
...
#else  // UP_ANY_USE(SMALL_MEMCPY_STRATEGY)
    template <class X = T, class... Args, 
...
#endif  // UP_ANY_USE(SMALL_MEMCPY_STRATEGY)
