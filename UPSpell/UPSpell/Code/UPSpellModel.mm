...
std::vector<int> SpellModel::all_time_game_scores(size_t limit)
{
...
std::vector<int> SpellModel::all_time_word_scores(size_t limit)
{
    std::vector<int> result;
...
SpellGameSummary SpellModel::most_recent_game()
{
    ...
    static const char *sql =
    "SELECT max(game_id), game_score, game_words_submitted_count, game_word_score_average, game_word_length_average, game_key FROM game;";
