...
- (instancetype)init
{
    ...
    self.timerLabel.colorCategory = UPColorCategoryInformation;
    ...
    self.gameScoreLabel.colorCategory = UPColorCategoryInformation;
    ...
    self.wordScoreLabel.colorCategory = UPColorCategoryInformation;
