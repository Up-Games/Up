...
void SpellLayout::calculate_description_font_metrics()
{
    ...
    UIFont *font = [UIFont descriptionFontWithCapHeight:cap_height];
...
void SpellLayout::calculate_dialog_title_font_metrics()
{
    ...
    UIFont *font = [UIFont dialogTitleFontWithCapHeight:cap_height];
...
void SpellLayout::calculate_dialog_locations()
{
    ...
    calculate_and_set_locations(Role::DialogButtonCenterResponse, up_center_aligned_rect(button_size, response_buttons_layout_frame));
...
void SpellLayout::calculate_extras_locations()
{
    ...
    CGRect icon_button_layout_frame = layout_relative_aspect_rect(CanonicalExtrasColorsIconButtonLayoutFrame);
