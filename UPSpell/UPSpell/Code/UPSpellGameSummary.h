...
public:
    ...
    m_game_id(game_id), m_game_score(game_score), m_game_words_submitted_count(words_submitted_count),
    ...
    int words_submitted_count() const { return m_game_words_submitted_count; }
...
private:
    ...
    int m_game_score = 0;
    int m_game_words_submitted_count = 0;
