...
- (instancetype)_init
{
    ...
    self.titleLabel.frame = layout.frame_for(Role::DialogShareHelpTitle);
    ...
    self.helpLabel.frame = layout.frame_for(Role::DialogShareHelpText);
    ...
    self.okButton.frame = layout.frame_for(Role::DialogShareHelpOKButton);
