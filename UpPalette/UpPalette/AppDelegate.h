...
extern NSString *const SecondaryFillKey;
...
extern NSString *const SecondaryStrokeKey;
extern NSString *const SecondaryInactiveStrokeKey;
extern NSString *const SecondaryActiveStrokeKey;
extern NSString *const SecondaryHighlightedStrokeKey;
extern NSString *const ContentKey;
extern NSString *const InactiveContentKey;
extern NSString *const ActiveContentKey;
extern NSString *const HighlightedContentKey;
extern NSString *const InformationKey;
extern NSString *const InfinityKey;
